...
<title>Register &mdash; Game Management</title>
...
<div class="auth-shell">
    <div class="auth-side">
        ...
        <p>Create your account to start tracking scores in the game system.</p>
        <ul class="feature-list">
            <li>&#10003; Add and edit scores</li>
            <li>&#10003; Track games and levels</li>
    ...
    <div class="auth-form-wrap">
        <div class="auth-card">
            ...
            <p class="muted">Register as a player</p>
            ...
            <form method="POST" action="index.php?page=register" class="form" novalidate>
                ...
                <div class="field">
                    ...
                    <input type="email" id="email" name="email"
                           ...
                           placeholder="e.g. player@example.com" required>
                </div>
                <div class="field">
